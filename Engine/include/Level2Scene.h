...
/*!
 * \class Level2Scene
 * \brief The Level2Scene class sets up and manages the second level of the game.
 *
 ...
 */
class Level2Scene : public BaseScene
{
    ...
    void SetupLevel() override
    {
        ...
        auto config = configManager.LoadConfig("Config/level2_config.txt");
