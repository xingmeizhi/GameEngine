...
/*!
 * \class Level3Scene
 * \brief The Level3Scene class sets up and manages the third level of the game.
 *
 ...
 */
class Level3Scene : public BaseScene
{
    ...
    void SetupLevel() override
    {
        ...
        auto config = configManager.LoadConfig("Config/level3_config.txt");
